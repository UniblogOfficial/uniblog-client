...
import { CarouselPlaceholder } from './carouselPlaceholder/CarouselPlaceholder';
...
export const CarouselField: FC<TDropZoneFieldProps> = ({ onChange, id }) => {
  ...
  return (
    <>
      <div className="dropbox">
        <CarouselPlaceholder isFilled={audio.length > 0} onDrop={onDrop} />
      </div>
